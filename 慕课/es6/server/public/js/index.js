...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Lottery = function (_mix) {
		...
		function Lottery() {
			...
			_this.open_code_list = new Set(); // 开奖号码集合
			_this.play_list = new Map(); // 玩法
			_this.number = new Set(); // 号码合集
	...
	var Base = function () {
	   ...
	   */
			...
			value: function changePlayNav(e) {
				...
				(0, _jquery2.default)(".boll_list .btn-boll").removeClass('btn-boll-active');
				self.getCount();
			}
			/**
	   * [assistHandle 操作区实现]
	   ...
	   */
			...
			value: function getCount() {
				...
				var count = self.computeCount(active, self.cur_play);
				var range = self.computeBonuns(active, self.cur_play);
				var money = count * 2;
				// win1 最小盈利 win2 最大盈利
...
/***/ (function(module, exports) {
	...
	var Calculate = function () {
	   ...
	   */
			...
			key: 'computeBonuns',
			value: function computeBonuns(active, play_name) {
				var self = this;
